...
export default {
  ...
  setup() {
    ...
    let udata = {
      'Melbourne': [0.05, 0.03, 0.04, 0.05, 0.06, 0.07, 0.08],
      'Sydney': [0.05, 0.03, 0.04, 0.05, 0.06, 0.07, 0.08],
      'Adelaide': [0.05, 0.03, 0.04, 0.05, 0.06, 0.07, 0.08],
      'Brisbane': [0.05, 0.03, 0.04, 0.05, 0.06, 0.07, 0.08],
      'Darwin': [0.05, 0.03, 0.04, 0.05, 0.06, 0.07, 0.08],
      'Hobart': [0.05, 0.03, 0.04, 0.05, 0.06, 0.07, 0.08],
      'Perth': [0.05, 0.03, 0.04, 0.05, 0.06, 0.07, 0.08]
    };
    let tdata = {
    ...
    //     if(cacheData[i].city=udata.Adelaide){
    //       cacheData[i].mon
    //     }else if(cacheData[i].city=udata.Brisbane){

    //     }else if(cacheData[i].city=udata.Darwin){

    //     }else if(cacheData[i].city=udata.Melbourne){

    //     }else if(cacheData[i].city=udata.Hobart){

    //     }else if(cacheData[i].city=udata.Perth){
    ...
    onMounted(() => {
      getState().then(() => {
        ...
        console.log(UData.data.data[0].city);
