...
class CallbackStreamListener(StreamListener):
    ...
    *not* guaranteed to receive these events forever, and should only be used
    ...
    def __init__(self, update_handler=None, local_update_handler=None, notification_handler=None,
                 conversation_handler=None, unknown_event_handler=None, status_update_handler=None):
